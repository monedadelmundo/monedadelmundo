...
"""Script for verifying MonedaDelMundo Core release binaries

This script attempts to download the signature file SHA256SUMS.asc from
monedadelmundocore.org and monedadelmundo.org and compares them.
...
WORKINGDIR = "/tmp/monedadelmundo_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://monedadelmundocore.org"
HOST2 = "https://monedadelmundo.org"
VERSIONPREFIX = "monedadelmundo-core-"
...
def main(args):
    ...
    if not success:
        print("monedadelmundo.org failed to provide signature file, "
              "but monedadelmundocore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("monedadelmundo.org and monedadelmundocore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the MonedaDelMundo Core binary release "
