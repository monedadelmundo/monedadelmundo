...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef MONEDADELMUNDO_CHAINPARAMSSEEDS_H\n')
    g.write('#define MONEDADELMUNDO_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the monedadelmundo network\n')
    ...
    g.write('#endif // MONEDADELMUNDO_CHAINPARAMSSEEDS_H\n')
