...
def main():
    ...
    # Filter out hosts with multiple monedadelmundo ports, these are likely abusive
    ips = filtermultiport(ips)
    print(f'{ip_stats(ips):s} Filter out hosts with multiple monedadelmundo ports', file=sys.stderr)
