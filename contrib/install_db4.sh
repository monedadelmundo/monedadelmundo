...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the monedadelmundo repository."
  exit 1
fi
...
# See https://github.com/monedadelmundo/monedadelmundo/issues/16064
...
echo 'When compiling monedadelmundod, run `./configure` in the following way:'
echo
