...
"""Example logging MonedaDelMundo Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/monedadelmundod
...
def main(monedadelmundod_path):
    ...
    b = BPF(text=program, usdt_contexts=[monedadelmundod_with_usdts])
