...
EXCLUDE = [
    # auto generated:
    'src/qt/monedadelmundostrings.cpp',
...
Arguments:
    <base_directory> - The base directory of a monedadelmundo source code repository.
...
Arguments:
    <file> - A source file in the monedadelmundo repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The MonedaDelMundo
