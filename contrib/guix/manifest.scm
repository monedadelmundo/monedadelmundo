...
(define* (make-monedadelmundo-cross-toolchain target
                                       #:key
...
desirable for building MonedaDelMundo Core release binaries."
...
(define-public glibc-2.27/monedadelmundo-patched
  (package
    (inherit glibc-2.31)
    (version "2.27")
    (source (origin
          ...
          ((string-contains target "-linux-")
           (list ;; Native GCC 7 toolchain
                 ...
                 (cond ((string-contains target "riscv64-")
                        (make-monedadelmundo-cross-toolchain target
                                                      #:base-libc glibc-2.27/monedadelmundo-patched
