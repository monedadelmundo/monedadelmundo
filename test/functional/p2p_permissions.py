...
class P2PPermissionsTests(MonedaDelMundoTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].monedadelmundoconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].monedadelmundoconf, 'w', encoding="utf8") as f:
            f.write(newText)
