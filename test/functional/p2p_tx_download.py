...
class TxDownloadTest(MonedaDelMundoTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new monedadelmundod instances, as setting mocktimes has long-term effects on when
