...
class TestShell:
    """Wrapper Class for MonedaDelMundoTestFramework.

    The TestShell class extends the MonedaDelMundoTestFramework
    ...
    class __TestShell(MonedaDelMundoTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by MonedaDelMundoTestFramework child class.
            self.num_nodes = 1
