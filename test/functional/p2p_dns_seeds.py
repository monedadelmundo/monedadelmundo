...
class P2PDNSSeeds(MonedaDelMundoTestFramework):
    ...
    def init_arg_tests(self):
        ...
        # Restore default monedadelmundod settings
        self.restart_node(0)
    ...
    def force_dns_test(self):
        ...
        with self.nodes[0].assert_debug_log(expected_msgs=["Loading addresses from DNS seed"], timeout=12):
            # -dnsseed defaults to 1 in monedadelmundod, but 0 in the test framework,
