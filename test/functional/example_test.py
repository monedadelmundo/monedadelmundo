...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MonedaDelMundoTestFramework
    pass


class ExampleTest(MonedaDelMundoTestFramework):
    # Each functional test is a subclass of the MonedaDelMundoTestFramework class.
    ...
    def custom_method(self):
        ...
        MonedaDelMundoTestFramework class so other tests can use it."""
