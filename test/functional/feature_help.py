...
"""Verify that starting monedadelmundo with -h works as expected."""

from test_framework.test_framework import MonedaDelMundoTestFramework
from test_framework.util import assert_equal

class HelpTest(MonedaDelMundoTestFramework):
    ...
    def run_test(self):
        self.log.info("Start monedadelmundo with -h for help text")
        ...
        self.log.info("Start monedadelmundo with -version for version information")
        ...
        self.log.info("Start monedadelmundod with -fakearg to make sure it does not start")
