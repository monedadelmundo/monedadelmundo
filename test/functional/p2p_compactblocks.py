...
# TestP2PConn: A peer we use to send messages to monedadelmundod, and store responses.
...
class CompactBlocksTest(MonedaDelMundoTestFramework):
    ...
    # This test actually causes monedadelmundod to (reasonably!) disconnect us, so do this last.
    ...
    # monedadelmundod's choice of nonce.
    ...
    # Test that monedadelmundod requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for monedadelmundod to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # monedadelmundod will not send blocktxn responses for blocks whose height is
