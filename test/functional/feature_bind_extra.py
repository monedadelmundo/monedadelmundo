...
"""
Test starting monedadelmundod with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(MonedaDelMundoTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that monedadelmundod has bound on "::1" (for RPC) and "::" (for P2P).
