...
class TestMonedaDelMundoCli(MonedaDelMundoTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `monedadelmundo-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and monedadelmundo-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and monedadelmundo-cli getwalletinfo return expected wallet info")
            ...
            # Test monedadelmundo-cli -generate.
            n1 = 3
            n2 = 4
            ...
            # Test monedadelmundo-cli -generate with -rpcwallet in multiwallet mode.
