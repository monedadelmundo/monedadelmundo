...
By default, monedadelmundod will dump mempool on shutdown and
...
class MempoolPersistTest(MonedaDelMundoTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent monedadelmundod from writing mempool.dat to disk. Verify that `savemempool` fails")
