...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/monedadelmundo/monedadelmundo/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(MonedaDelMundoTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our monedadelmundod node")
