...
Verify that a monedadelmundod node can use an external signer command.
...
class RPCSignerTest(MonedaDelMundoTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart monedadelmundod with -signer=<cmd>',
