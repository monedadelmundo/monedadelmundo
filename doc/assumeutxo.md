...
Assumeutxo is a feature that allows fast bootstrapping of a validating monedadelmundod
...
- [Github issue](https://github.com/monedadelmundo/monedadelmundo/issues/15605)
- [draft PR](https://github.com/monedadelmundo/monedadelmundo/pull/15606)
...
considered active. This is the "traditional" mode of operation for monedadelmundod.
...
**Failure consideration:** if monedadelmundod unexpectedly halts after `m_stop_use` is set on
...
### MonedaDelMundod restarts sometime after snapshot validation has completed

When monedadelmundod initializes again, what began as the snapshot chainstate is now
