...
This document provides guidelines for internationalization of the MonedaDelMundo Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `monedadelmundo_en.ts` remains unchanged.
