...
This guide describes how to build monedadelmundod, command-line utilities, and GUI on OpenBSD.
...
Clone the MonedaDelMundo Core repository to a directory. All build scripts and commands will run from this directory.
``` bash
...
MonedaDelMundo Core includes a GUI built with the cross-platform Qt Framework. To compile the GUI, Qt 5 is required.
...
(see issue [#6658](https://github.com/monedadelmundo/monedadelmundo/issues/6658)).
