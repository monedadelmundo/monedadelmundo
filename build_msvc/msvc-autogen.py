...
libs = [
    'libmonedadelmundo_cli',
    'libmonedadelmundo_common',
    'libmonedadelmundo_crypto',
    'libmonedadelmundo_node',
    'libmonedadelmundo_util',
    'libmonedadelmundo_wallet_tool',
    'libmonedadelmundo_wallet',
    'libmonedadelmundo_zmq',
    'bench_monedadelmundo',
    'libtest_util',
]
...
def parse_config_into_btc_config():
    ...
    config_dict["PACKAGE_STRING"] = f"\"MonedaDelMundo Core {version}\""

    with open(os.path.join(SOURCE_DIR,'../build_msvc/monedadelmundo_config.h.in'), "r", encoding="utf8") as template_file:
    ...
    with open(os.path.join(SOURCE_DIR,'../build_msvc/monedadelmundo_config.h'), "w", encoding="utf8") as btc_config:
...
def main():
    parser = argparse.ArgumentParser(description='MonedaDelMundo-core msbuild configuration initialiser.')
    ...
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/monedadelmundo_config.h'), os.path.join(SOURCE_DIR, 'config/monedadelmundo-config.h'))
