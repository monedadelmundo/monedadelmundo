...
export CONTAINER_NAME=ci_native_nowallet_libmonedadelmundokernel
...
export GOAL="install"
export MONEDADELMUNDO_CONFIG="--enable-reduce-exports CC=clang-8 CXX='clang++-8 -stdlib=libc++' --enable-experimental-util-chainstate"
