...
#ifndef MONEDADELMUNDO_INTERFACES_NODE_H
#define MONEDADELMUNDO_INTERFACES_NODE_H
...
//! Top-level interface for a monedadelmundo node (monedadelmundod process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // MONEDADELMUNDO_INTERFACES_NODE_H
