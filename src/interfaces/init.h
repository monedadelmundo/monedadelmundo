...
#ifndef MONEDADELMUNDO_INTERFACES_INIT_H
#define MONEDADELMUNDO_INTERFACES_INIT_H
...
//! (monedadelmundo-gui, monedadelmundo-node, monedadelmundo-wallet, monedadelmundod, monedadelmundo-qt) and each
...
#endif // MONEDADELMUNDO_INTERFACES_INIT_H
