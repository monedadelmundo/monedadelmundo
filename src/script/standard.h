...
#ifndef MONEDADELMUNDO_SCRIPT_STANDARD_H
#define MONEDADELMUNDO_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a monedadelmundo address
 */
...
/**
 * Generate a MonedaDelMundo scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // MONEDADELMUNDO_SCRIPT_STANDARD_H
