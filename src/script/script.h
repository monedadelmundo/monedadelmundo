...
#ifndef MONEDADELMUNDO_SCRIPT_SCRIPT_H
#define MONEDADELMUNDO_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, MonedaDelMundo always counted CHECKMULTISIGs
...
#endif // MONEDADELMUNDO_SCRIPT_SCRIPT_H
