...
#ifndef MONEDADELMUNDO_SCRIPT_MINISCRIPT_H
#define MONEDADELMUNDO_SCRIPT_MINISCRIPT_H
...
//! Parse a miniscript from a monedadelmundo script
...
#endif // MONEDADELMUNDO_SCRIPT_MINISCRIPT_H
