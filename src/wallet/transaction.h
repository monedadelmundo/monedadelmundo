...
#ifndef MONEDADELMUNDO_WALLET_TRANSACTION_H
#define MONEDADELMUNDO_WALLET_TRANSACTION_H
...
public:
     ...
     * on this monedadelmundo node, and set to 0 for transactions that were created
...
#endif // MONEDADELMUNDO_WALLET_TRANSACTION_H
