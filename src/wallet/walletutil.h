...
#ifndef MONEDADELMUNDO_WALLET_WALLETUTIL_H
#define MONEDADELMUNDO_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! monedadelmundo from opening the wallet, thinking it was newly created, and
...
#endif // MONEDADELMUNDO_WALLET_WALLETUTIL_H
