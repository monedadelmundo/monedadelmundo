...
#ifndef MONEDADELMUNDO_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define MONEDADELMUNDO_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // MONEDADELMUNDO_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
