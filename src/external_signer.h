...
#ifndef MONEDADELMUNDO_EXTERNAL_SIGNER_H
#define MONEDADELMUNDO_EXTERNAL_SIGNER_H
...
private:
    ...
    //! MonedaDelMundo mainnet, testnet, etc
    std::string m_chain;
...
#endif // MONEDADELMUNDO_EXTERNAL_SIGNER_H
