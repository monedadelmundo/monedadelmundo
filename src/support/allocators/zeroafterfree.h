...
#ifndef MONEDADELMUNDO_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define MONEDADELMUNDO_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // MONEDADELMUNDO_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
