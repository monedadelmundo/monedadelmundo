...
#ifndef MONEDADELMUNDO_CRYPTO_CHACHA_POLY_AEAD_H
#define MONEDADELMUNDO_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@monedadelmundo.
 *
 ...
 *
 * The chacha20-poly1305@monedadelmundo combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@monedadelmundo cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@monedadelmundo are relatively fast in
...
#endif // MONEDADELMUNDO_CRYPTO_CHACHA_POLY_AEAD_H
