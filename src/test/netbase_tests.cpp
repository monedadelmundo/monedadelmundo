...
{
    BOOST_CHECK(TestSplitHost("www.monedadelmundocore.org", "www.monedadelmundocore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.monedadelmundocore.org]", "www.monedadelmundocore.org", 0));
    BOOST_CHECK(TestSplitHost("www.monedadelmundocore.org:80", "www.monedadelmundocore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.monedadelmundocore.org]:80", "www.monedadelmundocore.org", 80));
