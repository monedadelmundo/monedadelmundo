...
#ifndef MONEDADELMUNDO_TEST_SCRIPTNUM10_H
#define MONEDADELMUNDO_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from MonedaDelMundo Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // MONEDADELMUNDO_TEST_SCRIPTNUM10_H
