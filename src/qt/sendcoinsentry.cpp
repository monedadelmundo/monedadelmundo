    ...
    platformStyle(_platformStyle)
{
    ...
    // normal monedadelmundo address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying monedadelmundo address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &MonedaDelMundoAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
