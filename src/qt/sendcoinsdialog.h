...
#ifndef MONEDADELMUNDO_QT_SENDCOINSDIALOG_H
#define MONEDADELMUNDO_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending monedadelmundos */
...
#endif // MONEDADELMUNDO_QT_SENDCOINSDIALOG_H
