...
#ifndef MONEDADELMUNDO_QT_WALLETMODEL_H
#define MONEDADELMUNDO_QT_WALLETMODEL_H
...
/** Interface to MonedaDelMundo wallet from Qt view code. */
...
#endif // MONEDADELMUNDO_QT_WALLETMODEL_H
