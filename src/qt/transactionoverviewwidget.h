...
#ifndef MONEDADELMUNDO_QT_TRANSACTIONOVERVIEWWIDGET_H
#define MONEDADELMUNDO_QT_TRANSACTIONOVERVIEWWIDGET_H
...
#endif // MONEDADELMUNDO_QT_TRANSACTIONOVERVIEWWIDGET_H
