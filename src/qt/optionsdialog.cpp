    ...
    mapper(nullptr)
{
    ...
    ui->monedadelmundoAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->monedadelmundoAtStartup);
    ...
    ui->monedadelmundoAtStartup->setToolTip(ui->monedadelmundoAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->monedadelmundoAtStartup->setText(ui->monedadelmundoAtStartup->text().arg(PACKAGE_NAME));

    ui->openMonedaDelMundoConfButton->setToolTip(ui->openMonedaDelMundoConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new MonedaDelMundoUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->monedadelmundoAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openMonedaDelMundoConfButton_clicked()
{
    ...
    if (!GUIUtil::openMonedaDelMundoConf())
