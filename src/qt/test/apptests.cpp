...
void AppTests::appTests()
{
    ...
    connect(&m_app, &MonedaDelMundoApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for MonedaDelMundoGUI tests.
void AppTests::guiTests(MonedaDelMundoGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &MonedaDelMundoGUI::consoleShown, this, &AppTests::consoleTests);
