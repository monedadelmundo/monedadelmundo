...
#ifndef MONEDADELMUNDO_QT_GUIUTIL_H
#define MONEDADELMUNDO_QT_GUIUTIL_H
...
/** Utility functions used by the MonedaDelMundo Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "monedadelmundo:" URI into recipient object, return true on successful parsing
...
#endif // MONEDADELMUNDO_QT_GUIUTIL_H
