...
static void SetupMonedaDelMundoUtilArgs(ArgsManager &argsman)
{
...
{
    SetupMonedaDelMundoUtilArgs(args);
    std::string error;
    ...
    if (HelpRequested(args) || args.IsArgSet("-version")) {
        ...
        std::string strUsage = PACKAGE_NAME " monedadelmundo-util utility version " + FormatFullVersion() + "\n";

        if (args.IsArgSet("-version")) {
            strUsage += FormatParagraph(LicenseInfo());
        } else {
            strUsage += "\n"
                "Usage:  monedadelmundo-util [options] [commands]  Do stuff\n";
            strUsage += "\n" + args.GetHelpMessage();
        }
