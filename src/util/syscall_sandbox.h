...
#ifndef MONEDADELMUNDO_UTIL_SYSCALL_SANDBOX_H
#define MONEDADELMUNDO_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during monedadelmundod initialization if MonedaDelMundo Core was compiled
...
#endif // MONEDADELMUNDO_UTIL_SYSCALL_SANDBOX_H
