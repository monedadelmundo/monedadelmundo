...
#ifndef MONEDADELMUNDO_UTIL_SETTINGS_H
#define MONEDADELMUNDO_UTIL_SETTINGS_H
...
//!       https://github.com/monedadelmundo/monedadelmundo/pull/15934/files#r337691812)
...
#endif // MONEDADELMUNDO_UTIL_SETTINGS_H
