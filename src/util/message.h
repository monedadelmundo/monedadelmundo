...
#ifndef MONEDADELMUNDO_UTIL_MESSAGE_H
#define MONEDADELMUNDO_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's monedadelmundo address, it must refer to a public key.
...
#endif // MONEDADELMUNDO_UTIL_MESSAGE_H
