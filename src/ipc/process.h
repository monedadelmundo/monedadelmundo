...
#ifndef MONEDADELMUNDO_IPC_PROCESS_H
#define MONEDADELMUNDO_IPC_PROCESS_H
...
//! IPC process interface for spawning monedadelmundo processes and serving requests
...
#endif // MONEDADELMUNDO_IPC_PROCESS_H
