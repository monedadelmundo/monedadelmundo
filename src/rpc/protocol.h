...
#ifndef MONEDADELMUNDO_RPC_PROTOCOL_H
#define MONEDADELMUNDO_RPC_PROTOCOL_H
...
//! MonedaDelMundo RPC error codes
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in monedadelmundod
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< MonedaDelMundo is not connected
...
#endif // MONEDADELMUNDO_RPC_PROTOCOL_H
