...
#ifndef MONEDADELMUNDO_PSBT_H
#define MONEDADELMUNDO_PSBT_H
...
struct PartiallySignedTransaction
{
    ...
    /** Merge psbt into this. The two psbts must have the same underlying CTransaction (i.e. the
      * same actual MonedaDelMundo transaction.) Returns true if the merge succeeded, false otherwise. */
