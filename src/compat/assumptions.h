...
#ifndef MONEDADELMUNDO_COMPAT_ASSUMPTIONS_H
#define MONEDADELMUNDO_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "MonedaDelMundo cannot be compiled without assertions."
#endif
...
#endif // MONEDADELMUNDO_COMPAT_ASSUMPTIONS_H
